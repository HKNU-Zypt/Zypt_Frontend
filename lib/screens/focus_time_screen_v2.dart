...
class CameraFocusPage extends StatefulWidget {
  const CameraFocusPage({super.key});

  @override
  _CameraFocusPageState createState() => _CameraFocusPageState();
}

class _CameraFocusPageState extends State<CameraFocusPage> {
